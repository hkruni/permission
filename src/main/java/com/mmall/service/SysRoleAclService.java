...
public class SysRoleAclService {
    ...
    public void changeRoleAcls(Integer roleId, List<Integer> aclIdList) {
        ...
        updateRoleAcls(roleId, aclIdList);//开始更新权限点列表
    ...
    public void updateRoleAcls(int roleId, List<Integer> aclIdList) {
        ...
        sysRoleAclMapper.deleteByRoleId(roleId);//先删除该角色ID点权限点

        if (CollectionUtils.isEmpty(aclIdList)) {
            return;
        }
        List<SysRoleAcl> roleAclList = Lists.newArrayList();//新的权限点列表
        ...
        sysRoleAclMapper.batchInsert(roleAclList);//批量插入
    }
